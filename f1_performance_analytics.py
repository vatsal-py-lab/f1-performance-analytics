{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyP4xeQuOUxYp0pyA+ID+2ic",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/vatsal-py-lab/f1-performance-analytics/blob/data-cleaning/f1_performance_analytics.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "K402xPm9czfI",
        "outputId": "c825faa2-3e3a-447d-db17-7651949f7f06",
        "collapsed": true
      },
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Requirement already satisfied: fastf1 in /usr/local/lib/python3.12/dist-packages (3.6.0)\n",
            ...
            "Requirement already satisfied: rapidfuzz in /usr/local/lib/python3.12/dist-packages (from fastf1) (3.13.0)\n",
            "Requirement already satisfied: requests-cache>=1.0.0 in /usr/local/lib/python3.12/dist-packages (from fastf1) (1.2.1)\n",
            ...
            "Requirement already satisfied: timple>=0.1.6 in /usr/local/lib/python3.12/dist-packages (from fastf1) (0.1.8)\n",
            "Requirement already satisfied: websockets<14,>=10.3 in /usr/local/lib/python3.12/dist-packages (from fastf1) (13.1)\n",
            ...
            "Requirement already satisfied: cattrs>=22.2 in /usr/local/lib/python3.12/dist-packages (from requests-cache>=1.0.0->fastf1) (25.1.1)\n",
            ...
            "Requirement already satisfied: url-normalize>=1.4 in /usr/local/lib/python3.12/dist-packages (from requests-cache>=1.0.0->fastf1) (2.2.1)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "adA9AezsFhsk",
        "outputId": "4331b1f8-ac2d-4642-b7c2-eef2514a8d51"
      },
      "execution_count": 3,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "pXiKnZCjGAWF",
        "outputId": "587eca02-55f8-4b5a-f1a7-5276c4e643ba"
      },
      "execution_count": 5,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "RSX7VHtGSnHJ",
        "outputId": "4e018886-e393-4e1e-acac-687a1cbb754c"
      },
      "execution_count": 7,
      "outputs": [
        {
